...
if fid > 0
    ...
    ChanName = cell(1,NumOutChans+1);                   % initialize the ChanName cell array
    ...
    ChanUnit = cell(1,NumOutChans+1);                   % initialize the ChanUnit cell array
    for iChan = 1:NumOutChans+1
...
%-----------------------------------------------------------------------------------------------------------------------------------
%mlb: Change for speed improvement suggested by Florian Stache on the forums (https://wind.nrel.gov/forum/wind/viewtopic.php?f=4&t=953&p=4010#p4010)
%    ip = 1;
%    for it = 1:NT
