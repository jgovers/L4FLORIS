      ...
      if ( Fatigue.DoShortTerm )
         ...
         for iFile = 1:nFiles  
            ...
            if ( Fatigue.BinCycles )
               ...
               Fatigue.File(iFile).Channel(iCh).binnedLifetimeCycles_NoGoodman  = FileBasedResults(iFile,iCh).binnedLifetimeCycles;
               Fatigue.File(iFile).Channel(iCh).binnedDamage_NoGoodman          = FileBasedResults(iFile,iCh).binnedDamage;
            end
