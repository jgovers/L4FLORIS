...
{
  extern unsigned int
    sf_NREL5MW_Baseline_loads_IPC_1P_v3_2014b_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_NREL5MW_Baseline_loads_IPC_1P_v3_2014b_process_check_sum_call(nlhs,plhs,
       nrhs,prhs))
    return 1;
  return 0;
}
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (strcmp(machineName, "NREL5MW_Baseline_loads_IPC_1P_v3_2014b") == 0) {
    sf_NREL5MW_Baseline_loads_IPC_1P_v3_2014b_uses_exported_functions(nlhs, plhs,
      nrhs-2, prhs+2);
    return 1;
  }
...
{
  extern unsigned int
    sf_NREL5MW_Baseline_loads_IPC_1P_v3_2014b_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "NREL5MW_Baseline_loads_IPC_1P_v3_2014b") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_NREL5MW_Baseline_loads_IPC_1P_v3_2014b_autoinheritance_info(nlhs,
      plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_NREL5MW_Baseline_loads_IPC_1P_v3_2014b_third_party_uses_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "NREL5MW_Baseline_loads_IPC_1P_v3_2014b") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_NREL5MW_Baseline_loads_IPC_1P_v3_2014b_third_party_uses_info(nlhs,
      plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_NREL5MW_Baseline_loads_IPC_1P_v3_2014b_jit_fallback_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "NREL5MW_Baseline_loads_IPC_1P_v3_2014b") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_NREL5MW_Baseline_loads_IPC_1P_v3_2014b_jit_fallback_info(nlhs,plhs,
      3,newRhs);
  }
...
{
  extern unsigned int
    sf_NREL5MW_Baseline_loads_IPC_1P_v3_2014b_updateBuildInfo_args_info( int
  ...
  if (strcmp(machineName, "NREL5MW_Baseline_loads_IPC_1P_v3_2014b") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_NREL5MW_Baseline_loads_IPC_1P_v3_2014b_updateBuildInfo_args_info
      (nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_NREL5MW_Baseline_loads_IPC_1P_v3_2014b_get_eml_resolved_functions_info
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 3) {
...
unsigned int sf_process_get_post_codegen_info(int nlhs, mxArray * plhs[], int
  nrhs, const mxArray * prhs[])
{
  extern void sf_NREL5MW_Baseline_loads_IPC_1P_v3_2014b_get_post_codegen_info
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 3) {
  ...
  machineName[(sizeof(machineName)/sizeof(char)-1)] = '\0';
  if (strcmp(machineName, "NREL5MW_Baseline_loads_IPC_1P_v3_2014b") == 0) {
    sf_NREL5MW_Baseline_loads_IPC_1P_v3_2014b_get_post_codegen_info(nlhs, plhs,
      nrhs-2, prhs+2);
    return 1;
  }
...
extern unsigned int sf_NREL5MW_Baseline_loads_IPC_1P_v3_2014b_method_dispatcher
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"NREL5MW_Baseline_loads_IPC_1P_v3_2014b")) {
    return(sf_NREL5MW_Baseline_loads_IPC_1P_v3_2014b_method_dispatcher
...
extern void NREL5MW_Baseline_loads_IPC_1P_v3_2014b_terminator(void);
void sf_machine_global_terminator(void)
{
  sfGlobalMdlStartCallCounts--;
  if (sfGlobalMdlStartCallCounts == 0) {
    NREL5MW_Baseline_loads_IPC_1P_v3_2014b_terminator();
...
extern void NREL5MW_Baseline_loads_IPC_1P_v3_2014b_initializer(void);
extern void NREL5MW_Baseline_loads_IPC_1P_v3_2014b_register_exported_symbols
  (SimStruct* S);
extern void NREL5MW_Baseline_loads_IPC_1P_v3_2014b_debug_initialize(struct
  SfDebugInstanceStruct*);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  NREL5MW_Baseline_loads_IPC_1P_v3_2014b_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      NREL5MW_Baseline_loads_IPC_1P_v3_2014b_debug_initialize
        (sfGlobalDebugInstanceStruct);
    }

    NREL5MW_Baseline_loads_IPC_1P_v3_2014b_initializer();
  }
