...
static void initialize_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
  (SFc4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *chartInstance);
static void initialize_params_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
  (SFc4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *chartInstance);
static void enable_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
  (SFc4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *chartInstance);
static void disable_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
  (SFc4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *chartInstance);
static void c4_update_debugger_state_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_
  (SFc4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
  (SFc4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *chartInstance);
static void set_sim_state_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
  (SFc4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *chartInstance,
   const mxArray *c4_st);
static void finalize_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
  (SFc4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *chartInstance);
static void sf_gateway_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
  (SFc4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *chartInstance);
static void mdl_start_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
  (SFc4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *chartInstance);
static void c4_chartstep_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
  (SFc4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *chartInstance);
static void initSimStructsc4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
  (SFc4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *chartInstance);
...
static uint8_T c4_e_emlrt_marshallIn
  (SFc4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *chartInstance,
   const mxArray *c4_b_is_active_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b,
  ...
  (SFc4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b = 0U;
  ...
  (SFc4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *chartInstance)
{
  ...
  c4_e_hoistedGlobal =
    chartInstance->c4_is_active_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b;
   ...
   const mxArray *c4_st)
{
  ...
  *chartInstance->c4_RatedSpeed = c4_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c4_is_active_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b =
    ...
    "is_active_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b");
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_(chartInstance);
  ...
  (SFc4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *chartInstance)
{
  ...
  chartInstance->c4_sfEvent = CALL_EVENT;
  c4_chartstep_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b(chartInstance);
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  const mxArray *c4_y = NULL;
  SFc4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *chartInstance;
  chartInstance = (SFc4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *)
    chartInstanceVoid;
   ...
   const char_T *c4_identifier)
{
  ...
  c4_y = c4_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b);
  return c4_y;
}
...
void sf_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b_get_check_sum(mxArray *
  plhs[])
{
...
mxArray* sf_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b_get_post_codegen_info
  (void);
mxArray
  *sf_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b_get_autoinheritance_info(void)
{
...
mxArray *sf_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b_third_party_uses_info
  (void)
{
...
mxArray *sf_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b_jit_fallback_info(void)
{
...
static const mxArray
  *sf_get_sim_state_info_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[5],T\"GenTorque\",},{M[1],M[11],T\"KillIntegrator\",},{M[1],M[18],T\"Mode\",},{M[1],M[9],T\"RatedSpeed\",},{M[8],M[0],T\"is_active_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance =
      (SFc4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *)
...
static void sf_opaque_initialize_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
  (void *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
    ((SFc4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct*)
     chartInstanceVar);
  initialize_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
    ((SFc4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b(void
  *chartInstanceVar)
{
  enable_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
    ((SFc4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b(void *
  chartInstanceVar)
{
  disable_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
    ((SFc4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b(void *
  chartInstanceVar)
{
  sf_gateway_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
    ((SFc4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct*)
     chartInstanceVar);
}

static const mxArray*
  sf_opaque_get_sim_state_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
    ((SFc4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
  (SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
    ((SFc4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct*)
     chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
  (void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    ...
    finalize_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
      ((SFc4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
    ((SFc4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct*)
     chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
  (SimStruct *S)
{
...
static void mdlRTW_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b(SimStruct *S)
{
  SFc4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *)
    utMalloc(sizeof(SFc4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b;
...
void c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b_method_dispatcher.\n"
