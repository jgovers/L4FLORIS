function [ table ] = windField2LUT_fun( inflowSetName, C2C_range )
% Set up settings
...
for iter = 1:N
    ...
    copyfile(['inflowProfiles\' inflowSetName '\' filename '.wnd'],'FAST_module\wind.wnd');
    copyfile(['inflowProfiles\' inflowSetName '\' filename '.sum'],'FAST_module\wind.sum');
