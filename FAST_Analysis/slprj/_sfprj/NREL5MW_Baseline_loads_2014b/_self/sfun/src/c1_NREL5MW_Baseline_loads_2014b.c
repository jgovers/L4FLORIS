...
static void initialize_c1_NREL5MW_Baseline_loads_2014b
  (SFc1_NREL5MW_Baseline_loads_2014bInstanceStruct *chartInstance);
static void initialize_params_c1_NREL5MW_Baseline_loads_2014b
  (SFc1_NREL5MW_Baseline_loads_2014bInstanceStruct *chartInstance);
static void enable_c1_NREL5MW_Baseline_loads_2014b
  (SFc1_NREL5MW_Baseline_loads_2014bInstanceStruct *chartInstance);
static void disable_c1_NREL5MW_Baseline_loads_2014b
  (SFc1_NREL5MW_Baseline_loads_2014bInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_NREL5MW_Baseline_loads_2014b
  (SFc1_NREL5MW_Baseline_loads_2014bInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_NREL5MW_Baseline_loads_2014b
  (SFc1_NREL5MW_Baseline_loads_2014bInstanceStruct *chartInstance);
static void set_sim_state_c1_NREL5MW_Baseline_loads_2014b
  (SFc1_NREL5MW_Baseline_loads_2014bInstanceStruct *chartInstance, const mxArray
   *c1_st);
static void finalize_c1_NREL5MW_Baseline_loads_2014b
  (SFc1_NREL5MW_Baseline_loads_2014bInstanceStruct *chartInstance);
static void sf_gateway_c1_NREL5MW_Baseline_loads_2014b
  (SFc1_NREL5MW_Baseline_loads_2014bInstanceStruct *chartInstance);
static void mdl_start_c1_NREL5MW_Baseline_loads_2014b
  (SFc1_NREL5MW_Baseline_loads_2014bInstanceStruct *chartInstance);
static void initSimStructsc1_NREL5MW_Baseline_loads_2014b
  (SFc1_NREL5MW_Baseline_loads_2014bInstanceStruct *chartInstance);
...
static real_T c1_emlrt_marshallIn
  (SFc1_NREL5MW_Baseline_loads_2014bInstanceStruct *chartInstance, const mxArray
   *c1_b_y, const char_T *c1_identifier);
...
static real_T c1_c_emlrt_marshallIn
  (SFc1_NREL5MW_Baseline_loads_2014bInstanceStruct *chartInstance, const mxArray
   *c1_b_y_out, const char_T *c1_identifier);
...
static void c1_eml_scalar_eg(SFc1_NREL5MW_Baseline_loads_2014bInstanceStruct
  *chartInstance);
...
static uint8_T c1_f_emlrt_marshallIn
  (SFc1_NREL5MW_Baseline_loads_2014bInstanceStruct *chartInstance, const mxArray
   *c1_b_is_active_c1_NREL5MW_Baseline_loads_2014b, const char_T *c1_identifier);
  ...
  (SFc1_NREL5MW_Baseline_loads_2014bInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_NREL5MW_Baseline_loads_2014b = 0U;
}
  ...
  (SFc1_NREL5MW_Baseline_loads_2014bInstanceStruct *chartInstance)
{
  ...
  c1_c_hoistedGlobal =
    chartInstance->c1_is_active_c1_NREL5MW_Baseline_loads_2014b;
   ...
   *c1_st)
{
  ...
  *chartInstance->c1_y_out = c1_c_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c1_is_active_c1_NREL5MW_Baseline_loads_2014b =
    ...
    "is_active_c1_NREL5MW_Baseline_loads_2014b");
  sf_mex_destroy(&c1_b_u);
  c1_update_debugger_state_c1_NREL5MW_Baseline_loads_2014b(chartInstance);
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_b_y = NULL;
  SFc1_NREL5MW_Baseline_loads_2014bInstanceStruct *chartInstance;
  chartInstance = (SFc1_NREL5MW_Baseline_loads_2014bInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c1_NREL5MW_Baseline_loads_2014b_get_eml_resolved_functions_info(void)
{
   ...
   *c1_b_is_active_c1_NREL5MW_Baseline_loads_2014b, const char_T *c1_identifier)
{
  ...
  c1_b_y = c1_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_NREL5MW_Baseline_loads_2014b), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_NREL5MW_Baseline_loads_2014b);
  return c1_b_y;
}
...
void sf_c1_NREL5MW_Baseline_loads_2014b_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c1_NREL5MW_Baseline_loads_2014b_get_post_codegen_info(void);
mxArray *sf_c1_NREL5MW_Baseline_loads_2014b_get_autoinheritance_info(void)
{
...

  {
    mxArray* mxPostCodegenInfo =
      sf_c1_NREL5MW_Baseline_loads_2014b_get_post_codegen_info();
...
mxArray *sf_c1_NREL5MW_Baseline_loads_2014b_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_NREL5MW_Baseline_loads_2014b_jit_fallback_info(void)
{
...
mxArray *sf_c1_NREL5MW_Baseline_loads_2014b_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c1_NREL5MW_Baseline_loads_2014b(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"y_out\",},{M[4],M[0],T\"y\",S'l','i','p'{{M1x2[66 67],M[0],}}},{M[8],M[0],T\"is_active_c1_NREL5MW_Baseline_loads_2014b\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_NREL5MW_Baseline_loads_2014b_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c1_NREL5MW_Baseline_loads_2014b(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_NREL5MW_Baseline_loads_2014bInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_NREL5MW_Baseline_loads_2014b
    ((SFc1_NREL5MW_Baseline_loads_2014bInstanceStruct*) chartInstanceVar);
  initialize_c1_NREL5MW_Baseline_loads_2014b
    ((SFc1_NREL5MW_Baseline_loads_2014bInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_NREL5MW_Baseline_loads_2014b(void
  *chartInstanceVar)
{
  enable_c1_NREL5MW_Baseline_loads_2014b
    ((SFc1_NREL5MW_Baseline_loads_2014bInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_NREL5MW_Baseline_loads_2014b(void
  *chartInstanceVar)
{
  disable_c1_NREL5MW_Baseline_loads_2014b
    ((SFc1_NREL5MW_Baseline_loads_2014bInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_NREL5MW_Baseline_loads_2014b(void
  *chartInstanceVar)
{
  sf_gateway_c1_NREL5MW_Baseline_loads_2014b
    ((SFc1_NREL5MW_Baseline_loads_2014bInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c1_NREL5MW_Baseline_loads_2014b
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c1_NREL5MW_Baseline_loads_2014b
    ((SFc1_NREL5MW_Baseline_loads_2014bInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c1_NREL5MW_Baseline_loads_2014b(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c1_NREL5MW_Baseline_loads_2014b
    ((SFc1_NREL5MW_Baseline_loads_2014bInstanceStruct*)chartInfo->chartInstance,
     st);
}

static void sf_opaque_terminate_c1_NREL5MW_Baseline_loads_2014b(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_NREL5MW_Baseline_loads_2014bInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c1_NREL5MW_Baseline_loads_2014b
      ((SFc1_NREL5MW_Baseline_loads_2014bInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_NREL5MW_Baseline_loads_2014b
    ((SFc1_NREL5MW_Baseline_loads_2014bInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_NREL5MW_Baseline_loads_2014b(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ...
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c1_NREL5MW_Baseline_loads_2014b
      ((SFc1_NREL5MW_Baseline_loads_2014bInstanceStruct*)
       (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c1_NREL5MW_Baseline_loads_2014b(SimStruct *S)
{
...
static void mdlRTW_c1_NREL5MW_Baseline_loads_2014b(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_NREL5MW_Baseline_loads_2014b(SimStruct *S)
{
  SFc1_NREL5MW_Baseline_loads_2014bInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc1_NREL5MW_Baseline_loads_2014bInstanceStruct *)utMalloc
    (sizeof(SFc1_NREL5MW_Baseline_loads_2014bInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_NREL5MW_Baseline_loads_2014b;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_NREL5MW_Baseline_loads_2014b;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_NREL5MW_Baseline_loads_2014b;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c1_NREL5MW_Baseline_loads_2014b;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_NREL5MW_Baseline_loads_2014b;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_NREL5MW_Baseline_loads_2014b;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_NREL5MW_Baseline_loads_2014b;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_NREL5MW_Baseline_loads_2014b;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_NREL5MW_Baseline_loads_2014b;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_NREL5MW_Baseline_loads_2014b;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_NREL5MW_Baseline_loads_2014b;
...
void c1_NREL5MW_Baseline_loads_2014b_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_NREL5MW_Baseline_loads_2014b(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_NREL5MW_Baseline_loads_2014b(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_NREL5MW_Baseline_loads_2014b(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_NREL5MW_Baseline_loads_2014b_method_dispatcher.\n"
