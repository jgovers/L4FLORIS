...
#include "c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b.h"
...
/* Named Constants */
#define CALL_EVENT                     (-1)
#define c5_b_DT                        (0.0125)

/* Variable Declarations */

/* Variable Definitions */
static real_T _sfTime_;
static const char * c5_debug_family_names[9] = { "rate", "DT", "nargin",
  "nargout", "u", "MinSaturation", "MaxSaturation", "y_out", "y" };

/* Function Declarations */
static void initialize_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
  (SFc5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *chartInstance);
static void initialize_params_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
  (SFc5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *chartInstance);
static void enable_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
  (SFc5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *chartInstance);
static void disable_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
  (SFc5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *chartInstance);
static void c5_update_debugger_state_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_
  (SFc5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
  (SFc5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *chartInstance);
static void set_sim_state_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
  (SFc5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *chartInstance,
   const mxArray *c5_st);
static void finalize_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
  (SFc5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *chartInstance);
static void sf_gateway_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
  (SFc5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *chartInstance);
static void mdl_start_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
  (SFc5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *chartInstance);
static void initSimStructsc5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
  (SFc5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *chartInstance);
...
static real_T c5_emlrt_marshallIn
  (SFc5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *chartInstance,
   const mxArray *c5_b_y, const char_T *c5_identifier);
...
static real_T c5_c_emlrt_marshallIn
  (SFc5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *chartInstance,
   const mxArray *c5_b_y_out, const char_T *c5_identifier);
...
static uint8_T c5_f_emlrt_marshallIn
  (SFc5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *chartInstance,
   const mxArray *c5_b_is_active_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b,
  ...
  (SFc5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_y_not_empty = false;
  chartInstance->c5_is_active_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b = 0U;
}
  ...
  (SFc5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *chartInstance)
{
  ...
  c5_st = NULL;
  c5_b_y = NULL;
  sf_mex_assign(&c5_b_y, sf_mex_createcellmatrix(3, 1), false);
  c5_hoistedGlobal = *chartInstance->c5_y_out;
  c5_b_u = c5_hoistedGlobal;
  c5_c_y = NULL;
  sf_mex_assign(&c5_c_y, sf_mex_create("y", &c5_b_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c5_b_y, 0, c5_c_y);
  c5_b_hoistedGlobal = chartInstance->c5_y;
  c5_c_u = c5_b_hoistedGlobal;
  c5_d_y = NULL;
  if (!chartInstance->c5_y_not_empty) {
  ...
  c5_c_hoistedGlobal =
    chartInstance->c5_is_active_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b;
   ...
   const mxArray *c5_st)
{
  ...
  *chartInstance->c5_y_out = c5_c_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c5_b_u, 0)), "y_out");
  chartInstance->c5_y = c5_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c5_b_u, 1)), "y");
  chartInstance->c5_is_active_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b =
    c5_f_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c5_b_u, 2)),
    "is_active_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b");
  sf_mex_destroy(&c5_b_u);
  c5_update_debugger_state_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_(chartInstance);
  ...
  (SFc5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *chartInstance)
{
  ...
  real_T c5_b_u;
  real_T c5_b_MinSaturation;
  real_T c5_b_MaxSaturation;
  ...
  _SFD_DATA_RANGE_CHECK(*chartInstance->c5_MinSaturation, 1U);
  chartInstance->c5_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 4U, chartInstance->c5_sfEvent);
  c5_hoistedGlobal = *chartInstance->c5_u;
  c5_b_hoistedGlobal = *chartInstance->c5_MinSaturation;
  c5_c_hoistedGlobal = *chartInstance->c5_MaxSaturation;
  c5_b_u = c5_hoistedGlobal;
  c5_b_MinSaturation = c5_b_hoistedGlobal;
  c5_b_MaxSaturation = c5_c_hoistedGlobal;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 9U, 9U, c5_debug_family_names,
    c5_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_rate, 0U, c5_b_sf_marshallOut,
    c5_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c5_c_DT, 1U, c5_b_sf_marshallOut);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_nargout, 3U, c5_b_sf_marshallOut,
    c5_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c5_b_u, 4U, c5_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c5_b_MinSaturation, 5U, c5_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c5_b_MaxSaturation, 6U, c5_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_b_y_out, 7U, c5_b_sf_marshallOut,
    c5_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&chartInstance->c5_y, 8U,
    c5_sf_marshallOut, c5_sf_marshallIn);
  c5_c_DT = c5_b_DT;
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, 2);
  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, 4);
  if (CV_EML_IF(0, 1, 0, !chartInstance->c5_y_not_empty)) {
    _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, 5);
    chartInstance->c5_y = c5_b_u;
    chartInstance->c5_y_not_empty = true;
  }

  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, 8);
  c5_d_hoistedGlobal = chartInstance->c5_y;
  c5_A = c5_b_u - c5_d_hoistedGlobal;
  c5_x = c5_A;
  c5_b_x = c5_x;
  c5_c_x = c5_b_x;
  c5_rate = c5_c_x / c5_b_DT;
  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, 9);
  c5_varargin_1 = c5_rate;
  c5_varargin_2 = c5_b_MinSaturation;
  ...
  c5_d_y = c5_yk;
  c5_eml_scalar_eg(chartInstance);
  c5_maxval = muDoubleScalarMax(c5_f_x, c5_d_y);
  c5_b_varargin_1 = c5_maxval;
  c5_c_varargin_2 = c5_b_MaxSaturation;
  c5_d_varargin_2 = c5_b_varargin_1;
  c5_b_varargin_3 = c5_c_varargin_2;
  c5_g_x = c5_d_varargin_2;
  c5_e_y = c5_b_varargin_3;
  c5_h_x = c5_g_x;
  c5_f_y = c5_e_y;
  c5_eml_scalar_eg(chartInstance);
  c5_b_xk = c5_h_x;
  ...
  c5_g_y = c5_b_yk;
  c5_eml_scalar_eg(chartInstance);
  c5_rate = muDoubleScalarMin(c5_i_x, c5_g_y);
  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, 11);
  chartInstance->c5_y += c5_rate * c5_b_DT;
  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, 12);
  c5_b_y_out = chartInstance->c5_y;
  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, -12);
  _SFD_SYMBOL_SCOPE_POP();
  *chartInstance->c5_y_out = c5_b_y_out;
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 4U, chartInstance->c5_sfEvent);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY
    (_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bMachineNumber_,
     chartInstance->chartNumber, chartInstance->instanceNumber);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c5_y_out, 2U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c5_MaxSaturation, 3U);
  _SFD_DATA_RANGE_CHECK(chartInstance->c5_DT, 4U);
}
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  const mxArray *c5_b_y = NULL;
  SFc5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *chartInstance;
  chartInstance = (SFc5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *)
    chartInstanceVoid;
   ...
   const mxArray *c5_b_u, const emlrtMsgIdentifier *c5_parentId)
{
  ...
  if (mxIsEmpty(c5_b_u)) {
    ...
    chartInstance->c5_y_not_empty = true;
    sf_mex_import(c5_parentId, sf_mex_dup(c5_b_u), &c5_d1, 1, 0, 0U, 0, 0U, 0);
    c5_b_y = c5_d1;
  }
   ...
   const mxArray *c5_b_y_out, const char_T *c5_identifier)
{
  ...
  c5_thisId.fIdentifier = c5_identifier;
  c5_thisId.fParent = NULL;
  c5_b_y = c5_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c5_b_y_out),
    &c5_thisId);
  sf_mex_destroy(&c5_b_y_out);
  return c5_b_y;
}
  ...
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData)
{
  ...
  chartInstance = (SFc5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *)
    chartInstanceVoid;
  c5_b_y_out = sf_mex_dup(c5_mxArrayInData);
  c5_identifier = c5_varName;
  c5_thisId.fIdentifier = c5_identifier;
  c5_thisId.fParent = NULL;
  c5_b_y = c5_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c5_b_y_out),
   ...
   const char_T *c5_identifier)
{
  ...
  c5_b_y = c5_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_b_is_active_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b), &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b);
  return c5_b_y;
}
  ...
  (SFc5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *chartInstance)
{
  chartInstance->c5_u = (real_T *)ssGetInputPortSignal_wrapper(chartInstance->S,
    0);
  chartInstance->c5_MinSaturation = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c5_y_out = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c5_MaxSaturation = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 2);
}
...
void sf_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b_get_check_sum(mxArray *
  plhs[])
{
...
mxArray* sf_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b_get_post_codegen_info
  (void);
mxArray
  *sf_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b_get_autoinheritance_info(void)
{
...

  {
    mxArray* mxPostCodegenInfo =
      sf_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b_get_post_codegen_info();
...
mxArray *sf_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b_third_party_uses_info
  (void)
{
...
mxArray *sf_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b_jit_fallback_info(void)
{
...
mxArray
  *sf_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b_updateBuildInfo_args_info
  (void)
{
...
static const mxArray
  *sf_get_sim_state_info_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"y_out\",},{M[4],M[0],T\"y\",S'l','i','p'{{M1x2[66 67],M[0],}}},{M[8],M[0],T\"is_active_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b_get_check_sum(&mxChecksum);
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_SET_DATA_VALUE_PTR(1U, chartInstance->c5_MinSaturation);
        _SFD_SET_DATA_VALUE_PTR(2U, chartInstance->c5_y_out);
        _SFD_SET_DATA_VALUE_PTR(3U, chartInstance->c5_MaxSaturation);
        _SFD_SET_DATA_VALUE_PTR(4U, &chartInstance->c5_DT);
      }
    } else {
...
static void sf_opaque_initialize_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
  (void *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
    ((SFc5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct*)
     chartInstanceVar);
  initialize_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
    ((SFc5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b(void
  *chartInstanceVar)
{
  enable_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
    ((SFc5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b(void *
  chartInstanceVar)
{
  disable_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
    ((SFc5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b(void *
  chartInstanceVar)
{
  sf_gateway_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
    ((SFc5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct*)
     chartInstanceVar);
}

static const mxArray*
  sf_opaque_get_sim_state_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
    ((SFc5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
  (SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
    ((SFc5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct*)
     chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
  (void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    ...
    finalize_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
      ((SFc5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
    ((SFc5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct*)
     chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b
  (SimStruct *S)
{
...
static void mdlRTW_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b(SimStruct *S)
{
  SFc5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct *)
    utMalloc(sizeof(SFc5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014bInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b;
...
void c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_NREL5MW_Baseline_loads_IPC_1P_2P_v2_2014b_method_dispatcher.\n"
