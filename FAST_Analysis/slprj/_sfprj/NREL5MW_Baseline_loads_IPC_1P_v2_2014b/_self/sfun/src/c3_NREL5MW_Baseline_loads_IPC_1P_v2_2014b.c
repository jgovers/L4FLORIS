...
static void initialize_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b
  (SFc3_NREL5MW_Baseline_loads_IPC_1P_v2_2014bInstanceStruct *chartInstance);
static void initialize_params_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b
  (SFc3_NREL5MW_Baseline_loads_IPC_1P_v2_2014bInstanceStruct *chartInstance);
static void enable_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b
  (SFc3_NREL5MW_Baseline_loads_IPC_1P_v2_2014bInstanceStruct *chartInstance);
static void disable_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b
  (SFc3_NREL5MW_Baseline_loads_IPC_1P_v2_2014bInstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_NREL5MW_Baseline_loads_IPC_1P_v2_201
  (SFc3_NREL5MW_Baseline_loads_IPC_1P_v2_2014bInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b
  (SFc3_NREL5MW_Baseline_loads_IPC_1P_v2_2014bInstanceStruct *chartInstance);
static void set_sim_state_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b
  (SFc3_NREL5MW_Baseline_loads_IPC_1P_v2_2014bInstanceStruct *chartInstance,
   const mxArray *c3_st);
static void finalize_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b
  (SFc3_NREL5MW_Baseline_loads_IPC_1P_v2_2014bInstanceStruct *chartInstance);
static void sf_gateway_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b
  (SFc3_NREL5MW_Baseline_loads_IPC_1P_v2_2014bInstanceStruct *chartInstance);
static void mdl_start_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b
  (SFc3_NREL5MW_Baseline_loads_IPC_1P_v2_2014bInstanceStruct *chartInstance);
static void initSimStructsc3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b
  (SFc3_NREL5MW_Baseline_loads_IPC_1P_v2_2014bInstanceStruct *chartInstance);
...
static uint8_T c3_e_emlrt_marshallIn
  (SFc3_NREL5MW_Baseline_loads_IPC_1P_v2_2014bInstanceStruct *chartInstance,
   const mxArray *c3_b_is_active_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b,
  ...
  (SFc3_NREL5MW_Baseline_loads_IPC_1P_v2_2014bInstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b = 0U;
  ...
  (SFc3_NREL5MW_Baseline_loads_IPC_1P_v2_2014bInstanceStruct *chartInstance)
{
  ...
  c3_d_hoistedGlobal =
    chartInstance->c3_is_active_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b;
   ...
   const mxArray *c3_st)
{
  ...
  *chartInstance->c3_SpeedError = c3_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c3_is_active_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b =
    ...
    "is_active_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_NREL5MW_Baseline_loads_IPC_1P_v2_201(chartInstance);
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_NREL5MW_Baseline_loads_IPC_1P_v2_2014bInstanceStruct *chartInstance;
  chartInstance = (SFc3_NREL5MW_Baseline_loads_IPC_1P_v2_2014bInstanceStruct *)
    chartInstanceVoid;
   ...
   const char_T *c3_identifier)
{
  ...
  c3_y = c3_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b);
  return c3_y;
}
...
void sf_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b_get_post_codegen_info(void);
mxArray *sf_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b_get_autoinheritance_info
  (void)
{
...
mxArray *sf_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b_jit_fallback_info(void)
{
...
mxArray *sf_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b_updateBuildInfo_args_info
  (void)
{
...
static const mxArray
  *sf_get_sim_state_info_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[10],T\"KillIntegrator\",},{M[1],M[5],T\"SpeedError\",},{M[3],M[11],T\"omega_C\",},{M[8],M[0],T\"is_active_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b(void *
  chartInstanceVar)
{
  chart_debug_initialization
    (((SFc3_NREL5MW_Baseline_loads_IPC_1P_v2_2014bInstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b
    ((SFc3_NREL5MW_Baseline_loads_IPC_1P_v2_2014bInstanceStruct*)
     chartInstanceVar);
  initialize_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b
    ((SFc3_NREL5MW_Baseline_loads_IPC_1P_v2_2014bInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b(void
  *chartInstanceVar)
{
  enable_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b
    ((SFc3_NREL5MW_Baseline_loads_IPC_1P_v2_2014bInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b(void
  *chartInstanceVar)
{
  disable_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b
    ((SFc3_NREL5MW_Baseline_loads_IPC_1P_v2_2014bInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b(void
  *chartInstanceVar)
{
  sf_gateway_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b
    ((SFc3_NREL5MW_Baseline_loads_IPC_1P_v2_2014bInstanceStruct*)
     chartInstanceVar);
}

static const mxArray*
  sf_opaque_get_sim_state_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b
    ((SFc3_NREL5MW_Baseline_loads_IPC_1P_v2_2014bInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b
  (SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b
    ((SFc3_NREL5MW_Baseline_loads_IPC_1P_v2_2014bInstanceStruct*)
     chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_NREL5MW_Baseline_loads_IPC_1P_v2_2014bInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b
      ((SFc3_NREL5MW_Baseline_loads_IPC_1P_v2_2014bInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b
    ((SFc3_NREL5MW_Baseline_loads_IPC_1P_v2_2014bInstanceStruct*)
     chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b(SimStruct
  *S)
{
...
static void mdlRTW_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b(SimStruct *S)
{
  SFc3_NREL5MW_Baseline_loads_IPC_1P_v2_2014bInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc3_NREL5MW_Baseline_loads_IPC_1P_v2_2014bInstanceStruct *)
    utMalloc(sizeof(SFc3_NREL5MW_Baseline_loads_IPC_1P_v2_2014bInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b;
...
void c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_NREL5MW_Baseline_loads_IPC_1P_v2_2014b_method_dispatcher.\n"
