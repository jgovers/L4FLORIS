--------------------------------------------------------------------------------
------- FAST INPUT FILE --------------------------------------------------------
Input files for FAST v7.02.
Created 25-Apr-2016 12:42:24.
---------------------- SIMULATION CONTROL --------------------------------------
...
9999.9      TYCOn       - Time to enable active yaw control (s) [unused when YCMode=0]
 ...
 1173.70      VS_RtGnSp   - Rated generator speed for simple variable-speed generator control (HSS side) (rpm) [used only when VSContrl=1]
 ...
 0.02557640      VS_Rgn2K    - Generator torque constant in Region 2 for simple variable-speed generator control (HSS side) (N-m/rpm^2) [used only when VSContrl=1]
  10        VS_SlPc     - Rated generator slip percentage in Region 2 1/2 for simple variable-speed generator control (percent) [used only when VSContrl=1]
...
9999.9      TPitManE(3) - Time at which override pitch maneuver for blade 3 reaches final pitch (s) [unused for 2 blades]
 0.106      BlPitch(1)  - Blade 1 initial pitch (degrees)
 0.106      BlPitch(2)  - Blade 2 initial pitch (degrees)
 0.106      BlPitch(3)  - Blade 3 initial pitch (degrees) [unused for 2 blades]
...
---------------------- INITIAL CONDITIONS --------------------------------------
  ...
  12.10      RotSpeed    - Initial or fixed rotor speed (rpm)
   0.0      NacYaw      - Initial or fixed nacelle-yaw angle (degrees)
   0.0      TTDspFA     - Initial fore-aft tower-top displacement (meters)
   0.0      TTDspSS     - Initial side-to-side tower-top displacement (meters)
---------------------- TURBINE CONFIGURATION -----------------------------------
 61.6333      TipRad      - The distance from the rotor apex to the blade tip (meters)
 2.8667      HubRad      - The distance from the rotor apex to the blade root (meters)
 ...
 1.98090      NacCMxn     - Downwind distance from the tower-top to the nacelle CM (meters)
...
---------------------- MASS AND INERTIA ----------------------------------------
 ...
 2.40E+05      NacMass     - Nacelle mass (kg)
 5.68E+04      HubMass     - Hub mass (kg)
...
---------------------- DRIVETRAIN ----------------------------------------------
 100.0      GBoxEff     - Gearbox efficiency (percent)
  94.4      GenEff      - Generator efficiency [ignored by the Thevenin and user-defined generator models] (percent)
...
9999.9      SIG_SlPc    - Rated generator slip percentage (percent) [used only when VSContrl=0 and GenModel=1]
...
"D:\jwvanwingerden\Desktop\FASTtool_Baseline\subfunctions\linearization_tower.dat"          TwrFile     - Name of file containing tower properties (quoted string)
---------------------- NACELLE-YAW ---------------------------------------------
...
---------------------- BLADE ---------------------------------------------------
"D:\jwvanwingerden\Desktop\FASTtool_Baseline\subfunctions\linearization_blade.dat"                  BldFile(1)  - Name of file containing properties for blade 1 (quoted string)
"D:\jwvanwingerden\Desktop\FASTtool_Baseline\subfunctions\linearization_blade.dat"                  BldFile(2)  - Name of file containing properties for blade 2 (quoted string)
"D:\jwvanwingerden\Desktop\FASTtool_Baseline\subfunctions\linearization_blade.dat"                  BldFile(3)  - Name of file containing properties for blade 3 (quoted string) [unused for 2 blades]
---------------------- AERODYN -------------------------------------------------
"D:\jwvanwingerden\Desktop\FASTtool_Baseline\subfunctions\linearization_Aerodyn.ipt"                 LinFile     - Name of file containing FAST linearization parameters (quoted string) [unused when AnalMode=1]
---------------------- NOISE ---------------------------------------------------
"Dummy"     NoiseFile   - Name of file containing aerodynamic noise input parameters (quoted string) [used only when CompNoise=True]
---------------------- ADAMS ---------------------------------------------------
"D:\jwvanwingerden\Desktop\FASTtool_Baseline\subfunctions\linearization_ADAMS.dat"          ADAMSFile   - Name of file containing ADAMS-specific input parameters (quoted string) [unused when ADAMSPrep=1]
---------------------- LINEARIZATION CONTROL -----------------------------------
"D:\jwvanwingerden\Desktop\FASTtool_Baseline\subfunctions\linearization_linear.dat"                 LinFile     - Name of file containing FAST linearization parameters (quoted string) [unused when AnalMode=1]
---------------------- OUTPUT --------------------------------------------------
...
"RootMFlp1, RootMFlp2, RootMFlp3"
"RootMEdg1, RootMEdg2, RootMEdg3"
"TwrBsMxt , TwrBsMyt , TwrBsMzt"
"LSSTipMya, LSSTipMza, LSSTipVxa"
"GenPwr   , GenTq    , GenSpeed"
"BlPitch1 , Azimuth"
"RotPwr   , RotThrust"
"RotSpeed , HSShftTq"
