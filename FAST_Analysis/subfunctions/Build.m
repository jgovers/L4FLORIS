...
if FileName
    ...
    % Update text boxes
    set(handles.TurbineFile_textbox, 'String', [PathName,FileName]);
    set(handles.TowerFile_textbox, 'String', [PathName,FileName(1:end-4), '_tower.dat']);
    set(handles.BladeFile_textbox, 'String', [PathName,FileName(1:end-4), '_blade.dat']);
    set(handles.AeroDynFile_textbox, 'String', [PathName,FileName(1:end-4), '_AeroDyn.ipt']);
    set(handles.ADAMSFile_textbox, 'String', [PathName,FileName(1:end-4), '_ADAMS.dat']);
    set(handles.LinearFile_textbox, 'String', [PathName,FileName(1:end-4), '_linearized.mat']);

    % Enable buttons
    set(handles.WriteFAST, 'Enable', 'on');
    set(handles.TurbineFile_textbox, 'Enable', 'on');
    set(handles.TowerFile_textbox, 'Enable', 'on');
    set(handles.BladeFile_textbox, 'Enable', 'on');
    set(handles.AeroDynFile_textbox, 'Enable', 'on');
    set(handles.ADAMSFile_textbox, 'Enable', 'on');
    set(handles.LinearFile_textbox, 'Enable', 'on');
...
% Turbine input file
fid = fopen(get(handles.TurbineFile_textbox, 'String'), 'wt');
fprintf(fid, '--------------------------------------------------------------------------------\n');
...
% Tower input file
fid = fopen(get(handles.TowerFile_textbox, 'String'), 'wt');
fprintf(fid, '--------------------------------------------------------------------------------\n');
...
% Blade nodes in 4-decimal precision
r = 1e-4 * round(handles.Blade_Radius*1e4);
...
% Blade input file
fid = fopen(get(handles.BladeFile_textbox, 'String'), 'wt');
fprintf(fid, '--------------------------------------------------------------------------------\n');
...
% Airfoil files
copyfile([pwd, '\subfunctions\AeroData\Cylinder1.dat'], [FileName, '_airfoil_Cylinder1.dat']);
copyfile([pwd, '\subfunctions\AeroData\Cylinder2.dat'], [FileName, '_airfoil_Cylinder2.dat']);
copyfile([pwd, '\subfunctions\AeroData\DU40_A17.dat'], [FileName, '_airfoil_DU40_A17.dat']);
copyfile([pwd, '\subfunctions\AeroData\DU35_A17.dat'], [FileName, '_airfoil_DU35_A17.dat']);
copyfile([pwd, '\subfunctions\AeroData\DU30_A17.dat'], [FileName, '_airfoil_DU30_A17.dat']);
copyfile([pwd, '\subfunctions\AeroData\DU25_A17.dat'], [FileName, '_airfoil_DU25_A17.dat']);
copyfile([pwd, '\subfunctions\AeroData\DU21_A17.dat'], [FileName, '_airfoil_DU21_A17.dat']);
copyfile([pwd, '\subfunctions\AeroData\NACA64_A17.dat'], [FileName, '_airfoil_NACA64_A17.dat']);

% AeroDyn input file
fid = fopen(get(handles.AeroDynFile_textbox, 'String'), 'wt');
fprintf(fid, 'Created %s.\n', datestr(now));
...
% ADAMS input file
fid = fopen(get(handles.ADAMSFile_textbox, 'String'), 'wt');
fprintf(fid, '--------------------------------------------------------------------------------\n');
