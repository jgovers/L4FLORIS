 function write_lifetime_dels_as_text( progName, outputFilename, FileInfo, Fatigue )
   ...
   if (Fatigue.UserDistrib == 0) % Only create the weibull table if not using user-supplied distributions
      ...
      fprintf( fid, 'A user-supplied joint PDF was used to scale cycle counts over the design lifetime.' );
   end
