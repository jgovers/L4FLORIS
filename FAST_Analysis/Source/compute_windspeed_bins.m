...
%  Called by: mlife
   ...
   Fatigue.TimePP = zeros( sum(Fatigue.nWSbins) );
   Fatigue.TimeIdle = zeros( sum(Fatigue.nWSbins) );
   ...
   for iFile=1:nDLC2Files
      ...
      Fatigue.TimeIdle(WSbin)    = Fatigue.TimeIdle(WSbin) + Fatigue.ElapTime(iFile+nDLC1Files);
   end
   return
