         ...
         if ( Fatigue.DoShortTerm )  
            ...
            if (Fatigue.DEL_Type == 1 || Fatigue.DEL_Type == 3)
               ...
               if ( Fatigue.BinCycles )
                  ...
                  Fatigue.File(iFile).Channel(iCh).binnedLifetimeCycles_FixedMeans  = FileBasedResultsF(iFile,iCh).binnedLifetimeCycles;
                  Fatigue.File(iFile).Channel(iCh).binnedDamage_FixedMeans          = FileBasedResultsF(iFile,iCh).binnedDamage;
               end
            ...
            if (Fatigue.DEL_Type == 2 || Fatigue.DEL_Type == 3)
               ...
               if ( Fatigue.BinCycles )
                  ...
                  Fatigue.File(iFile).Channel(iCh).binnedLifetimeCycles_ZeroMeans     = FileBasedResultsZ(iFile,iCh).binnedLifetimeCycles; 
                  Fatigue.File(iFile).Channel(iCh).binnedDamage_ZeroMeans             = FileBasedResultsZ(iFile,iCh).binnedDamage;
               end
